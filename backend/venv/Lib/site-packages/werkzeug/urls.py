...
def iri_to_uri(iri: str) -> str:
    ...
    path = url_quote(parts.path, safe="%!$&'()*+,/:;=@")
    query = url_quote(parts.query, safe="%!$&'()*+,/:;=?@")
    fragment = url_quote(parts.fragment, safe="%!#$&'()*+,/:;=?@")
    ...
    if parts.username:
        auth = url_quote(parts.username, safe="%!$&'()*+,;=")

        if parts.password:
            password = url_quote(parts.password, safe="%!$&'()*+,;=")
            auth = f"{auth}:{password}"
